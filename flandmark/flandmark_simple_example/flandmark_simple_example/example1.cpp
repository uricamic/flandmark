...
int main()
{
	...
	IplImage *frame = cvLoadImage("E:/Users/daniyuu/Lab/flandmark/data/Images/Aaron_Eckhart_0001.jpg");
	/*if (frame == NULL)
	{
	...
	cvSaveImage("E:/Users/daniyuu/Lab/flandmark/record/simple_example/out_Aaron_Eckhart_0001.jpg", frame);
	system("pause");
	// cleanup
	free(bbox);
	free(landmarks);
